...
fn class_definition(
	...
	let class_definition = parse2(quote_spanned!(span => impl #ion::ClassDefinition for #r#type {
		...
		fn proto_class() -> Option<&'static #ion::class::NativeClass> {
			Self::__ion_bindings_proto_class()
		}

		fn parent_prototype(cx: &#ion::Context) -> Option<#ion::Local<*mut ::mozjs::jsapi::JSObject>> {
			Self::__ion_bindings_parent_prototype(cx)
		}
